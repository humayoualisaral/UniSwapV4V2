...
import {DeployDynamicFeeModule_CapFactory} from "script/DeployDynamicFeeModule_CapFactory.s.sol";
...
contract DeployDynamicFeeModuleForkTest_CapFactory is Test {
    using stdJson for string;

    DeployDynamicFeeModule_CapFactory public deployDynamicFee;
    ...
    function setUp() public {
        ...
        clFactory = CLFactory(0xaDe65c38CD4849aDBA595a4323a8C7DdfE89716a);
    ...
    function test_deployDynamicFee() public {
        dynamicFeeModule = DynamicSwapFeeModule(0xF4Ecd78EBEB6d36CF7f80B5B6B41453515fe2785);
        ...
        assertEq(dynamicFeeModule.defaultFeeCap(), oldModule.defaultFeeCap());
